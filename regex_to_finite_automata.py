...
#POUR POUVOIR UTILISER TOUS LES LETTRES DE L'ALPHABET ET DONC EVITER L'UTILISATION DES LETTRES SPECIAUX
    @staticmethod
    def epsilon():
        return ":e:"
...
class BuildAutomata:
# c'est une class d'utilite, elle contient les differentes methodes qui nous permet de creer les automates
    @staticmethod
    def basicstruct(inp):
        state1 = 1
        state2 = 2
...
class Apg:
# la class utilise pour creer les automates partiellement generalise a partir des expressions reguliers
...
reg_ex = input('''Enter your regular expression
   : ''')

result = Apg(reg_ex)

print(result.nfa.display())
